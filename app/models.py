...
man_devices = {'10.254.1.1': '<93>上海新业[10.254.1.1]', '10.254.1.27': '<93>上海418[10.254.1.27]',
               ...
               '10.254.1.45': '<68>上海418-2[10.254.1.45]', '10.254.1.48': '<68>上海斜土路[10.254.1.48]',
               '10.254.1.31': '<67>上海常科发[10.254.1.31]', '10.254.1.43': '<68>上海全华[10.254.1.43]',
               '10.254.1.39': '<68>上海数讯-方春路[10.254.1.39]', '10.254.1.38': '<68>上海数讯-秦桥路[10.254.1.38]',
               '10.254.1.40': '<68>上海云立方[10.254.1.40]', '10.254.1.42': '<68>上海GDS(HW)[10.254.1.42]',
               '10.254.1.46': '<68>上海纪蕴路阿里[10.254.1.46]', '10.254.1.34': '<68>上海中信[10.254.1.34]',
               '10.254.1.32': '<68>上海GDS中信[10.254.1.32]', '10.254.1.54': '<67>上海418[10.254.1.54]',
               '10.254.1.52': '<67>上海鹏博士[10.254.1.52]', '10.254.1.53': '<67>上海鹏博士(24)[10.254.1.53]',
               '10.254.1.51': '<67>上海数据港[10.254.1.51]', '10.254.1.57': '<57>上海418[10.254.1.57]',
               '10.254.1.33': '<57>上海GDS[10.254.1.33]', '10.254.1.4': '<53>上海SITV(文广)[10.254.1.4]',
               '10.254.1.50': '<53>上海数据港[10.254.1.50]', '10.254.1.49': '<53>上海纪蕴路[10.254.1.49]',
               '10.254.1.70': '<53>上海418-1.70[10.254.1.70]', '10.254.1.17': '<53>上海418-1.17[10.254.1.17]',
               '10.220.1.1': '<128>上海418[10.220.1.1]', '10.254.50.3': '<57>广州中信[10.254.50.3]',
               '10.254.50.2': '<93>广州自建(50.2)[10.254.50.2]', '10.254.50.5': '<93>广州自建(50.5)[10.254.50.5]',
               '10.254.50.200': '<68>广州自建[10.254.50.200]', '10.254.50.8': '<68>广州大学城[10.254.50.8]',
               '10.254.50.13': '<68>广州华兴园-YT[10.254.50.13]', '10.254.50.9': '<68>广州华兴园[10.254.50.9]',
               '10.220.50.10': '<68>广州UC鸿景[10.220.50.10]', '10.254.50.4': '<67>广州中信[10.254.50.4]',
               '10.220.50.1': '<128>广州自建[10.220.50.1]', '10.254.2.13': '<68>北京百度[10.254.2.13]',
               '10.254.2.34': '<68>北京中金POP[10.254.2.34]', '2.40,2.41': '<68>北京京东有孚(40,41)[10.254.2.40]',
               '10.254.2.33': '<68>北京中航信[10.254.2.33]', '10.254.2.39': '<67>北京自建[10.254.2.39]',
               '10.254.2.26': '<67>北京朝阳公园[10.254.2.26]', '10.254.2.43': '<67>北京京城大厦[10.254.2.43]',
               '10.254.2.44': '<67>北京中电华通[10.254.2.44]', '10.254.2.35': '<67>北京酒仙桥M8[10.254.2.35]',
               '10.254.2.25': '<67>北京安华桥[10.254.2.25]', '10.254.2.23': '<67>北京北矿[10.254.2.23]',
               '10.254.2.32': '<67>北京新技术大厦POP[10.254.2.32]', '10.254.2.28': '<67>北京大红门POP[10.254.2.28]',
               '10.254.2.16': '<67>北京亦庄POP[10.254.2.16]', '10.254.2.27': '<67>北京银科[10.254.2.27]',
               '10.254.2.24': '<67>北京上地机房[10.254.2.24]', '10.220.2.10': '<67>北京夕照寺[10.220.2.10]',
               '10.253.2.18': '<67>北京东方广场[10.253.2.18]', '10.254.2.15': '<67>北京自建(环)[10.254.2.15]',
               '10.254.2.19': '<67>北京汇天[10.254.2.19]', '10.254.2.8': '<57>北京自建(2.8)[10.254.2.8]',
               '10.254.2.11': '<57>北京自建(2.11)[10.254.2.11]', '10.254.2.30': '<57>北京office[10.254.2.30]',
               '10.254.2.42': '<57>北京朝阳公园(2.42)[10.254.2.42]', '10.254.2.45': '<57>北京朝阳公园(2.45)[10.254.2.45]',
               '10.254.2.38': '<57>北京北矿[10.254.2.38]', '10.254.2.12': '<53>北京office[10.254.2.12]',
               '10.254.2.46': '<53>北京安华桥[10.254.2.46]', '10.254.2.1': '<93>北京自建(骨干)[10.254.2.1]',
               '10.254.2.6': '<93>北京自建(环)[10.254.2.6]', '10.220.2.1': '<128>北京自建(骨干)[10.220.2.1]',
               '10.230.2.1': '<128>北京自建(VS2)[10.230.2.1]', '10.254.52.9': '<57>深圳互盟[10.254.52.9]',
               '10.254.52.1': '<68>深圳自建[10.254.52.1]', '10.254.52.4': '<68>深圳中信[10.254.52.4]',
               '10.254.52.6': '<68>深圳夏龙[10.254.52.6]', '10.254.52.7': '<68>深圳互盟[10.254.52.7]',
               '10.254.52.8': '<68>深圳福保奥飞[10.254.52.8]', '10.254.52.5': '<68>深圳福保万国YT[10.254.52.5]',
               '10.254.52.11': '<E350>深圳宝德[10.254.52.11]', '10.254.52.12': '<E350>深圳福保奥飞[10.254.52.12]',
               '10.254.52.200': '<93>深圳自建[10.254.52.200]', '10.220.52.1': '<128>深圳自建[10.220.52.1]'}
