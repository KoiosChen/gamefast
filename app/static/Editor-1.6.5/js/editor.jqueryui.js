...
(function( factory ){
	if ( typeof define === 'function' && define.amd ) {
		// AMD
		define( ['jquery', 'datatables.net-jqui', 'datatables.net-vxlan_table'], function ( $ ) {
		...
		module.exports = function (root, $) {
			...
			if ( ! $.fn.dataTable.Editor ) {
				require('datatables.net-vxlan_table')(root, $);
			}
	...
	init: function ( dte ) {
		dte.__dialouge = $('<div/>')
			...
			.dialog( $.extend( true, Editor.display.jqueryui.modalOptions, {
				...
				closeOnEscape: false // allow vxlan_table's escape function to run
			} ) );
