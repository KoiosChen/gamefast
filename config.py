...
class DevelopmentConfig(Config):
    ...
    DB_DATABASE = os.environ.get('DEV_DATABASE_DATABASE') or 'gamefast'
...
class TestingConfig(Config):
    ...
    DB_PASSWORD = os.environ.get('TEST_DATABASE_PASSWORD') or 'Gamefast_1324'
    DB_HOST = os.environ.get('TEST_DATABASE_HOST') or '10.250.62.1'
    DB_DATABASE = os.environ.get('TEST_DATABASE_DATABASE') or 'gamefast'
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://' + DB_USERNAME + ':' + DB_PASSWORD + '@' + DB_HOST + '/' + DB_DATABASE
